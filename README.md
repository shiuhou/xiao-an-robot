...
8. Continue the layered migration from the landed mergetesting `app/` + `services/` slice toward reusable `hal/transport/protocol` modules.
9. Review remote perception/memory branches deliberately before merging into `main`.
