...
LINK1_REPLIES = {
    "capture_schedule": (
        "日程我加上啦，小安把它放进今天的小格子里啦。",
        "收到，这个安排我乖乖放到日程里，到点前会帮你盯着。",
        "好呀，我把这件事排进日程，不让它偷偷溜走。",
    ),
    "capture_reminder": (
        "我记好啦，到点小安带着小提醒来敲敲你。",
        "提醒已经收进小安的小闹钟啦，时间一到我就乖乖冒出来。",
        "好呀，这件事先交给我，你的小脑袋可以少背一点点。",
    ),
    "capture_meeting": (
        "会议信息我先抱住啦，重点我会帮你稳稳放好。",
        "收到，这是会议相关内容，我帮你塞进会议小格子里。",
        "会议笔记我记下啦，你继续说重点，小安认真听着。",
    ),
    "capture_task": (
        "待办我收下啦，你先不用把它一直挂在脑袋上。",
        "任务已加入小安清单，我会帮你盯住这个小尾巴。",
        "好呀，这件事我先放进待处理队列，稳稳接住啦。",
    ),
    "capture_note": (
        "我先帮你记一下，小安的小本本已经翻开啦。",
        "收到，我把这句话先放进小本本，不让它飞走。",
        "这条笔记我记下啦，之后我们可以慢慢把它养成方案。",
    ),
    "capture_preference": (
        "我记住啦，你喜欢科幻故事，小安的小天线已经收藏好。",
    ),
    "recall_preference": (
        "你喜欢科幻故事，所以我下次可以给你讲一点星际探险。",
    ),
    "recall_identity": (
        "我知道你是小安项目的负责人，正在带着小安准备今天的演示。",
    ),
    "recall_current_work": (
        "你最近在准备小安机器人的成品演示，我会把提醒、日程和互动环节都乖乖记住。",
    ),
    "recall_demo_goal": (
        "你希望我展示语音记忆、主动提醒、视觉关怀和具身陪伴能力，小安正在努力长大。",
    ),
    "no_speech": (
        "我刚刚没听清。你再叫我一声，我会竖起小耳朵认真听。",
        "好像有点太轻啦，再说一次，我把耳朵竖起来。",
        "我没抓到内容，我们再来一遍就好，小安不着急。",
    ),
    "reminder_due": (
        "到点啦，小安出来轻轻提醒你，该处理刚才那件事啦。",
        "小安提醒时间到。先停一下，我们把这件事捡起来。",
        "你交给我的提醒到时间啦，我来乖乖报到，不会漏掉。",
    ),
}

LINK2_REPLIES = {
    "visual_care": (
        "我看到你有点累啦，先眨眨眼，肩膀放下来，小安陪你休息一分钟。",
        "你现在看起来有点疲惫，我们先把节奏放慢一点，小安陪你缓一缓。",
        "小安检测到你可能累了，先喝口水，眼睛离屏幕远一点点。",
    ),
    "visual_uncertain": (
        "我这边还没看清你。你可以稍微靠近一点点，等我看清了再乖乖判断。",
        "画面有点不稳定，我先不乱判断。你调整一下位置，小安再认真看。",
        "我好像没抓到清楚的人脸，先等等，小安不急着打扰你。",
    ),
    "visual_normal": (
        "我看你状态还挺稳的。小安在线巡逻中，有需要我就马上冒出来。",
        "目前看起来还不错，我会继续安静陪跑，像桌角的小助手一样。",
...
EXPRESSION_PERFORMANCE_REPLIES = {
    "happy": "嘿嘿，我现在是开心模式，准备把气氛点亮一点点。",
    "caring": "我切到关心模式啦。你慢慢来，小安会温柔一点陪着你。",
    "tired": "我现在装作有点困，眼睛都快要自动进入省电模式啦。",
    "thinking": "我进入思考模式。让我认真想一想，再给你一个稳妥答案。",
    "speaking": "我切到说话模式啦。现在轮到小安认真播报。",
    "idle": "我回到待命表情啦。安静在线，有事你叫我。",
    "sad": "我现在是难过表情。没关系，小安会慢慢把情绪接住。",
    "surprised": "哇，我现在很惊讶。这个反应够亮晶晶了吗？",
