...
| [runbooks/work_mode_real_demo_flow.md](runbooks/work_mode_real_demo_flow.md) | Real total-work-mode demo script covering voice, local fast paths, OpenClaw, reminders, robot actions, camera, and recovery. |
