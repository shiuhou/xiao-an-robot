...
| `mergetesting_care_demo_face240_spoken_tts_din41_ota_usb` | P/H: 2026-07-08 build PASS; enables ArduinoOTA for the DIN41 spoken TTS demo path | H: 2026-07-05 USB upload PASS on `/dev/ttyACM0`; serial boot showed WiFi `PnX`, robot IP `192.168.31.176`, `OTA Ready hostname=xiao-an-esp32 auth=disabled`, face240/motor/speaker enabled, robot mic/video disabled. 2026-07-08 replaced speaker with `4 ohm 3 W, 500-5000 Hz`; current accepted spoken TTS baseline is DIN41 full PCM buffered playback, `XIAOAN_TTS_TARGET_PEAK=500`, default SAPI rate, `Microsoft Hanhan Desktop`, and `MERGETEST_SPEAKER_STREAM_GAIN=32`. Direct Chinese TTS completed `audio.playback_done ok bytes=367384 duration_ms=5763`; user reported it was very clear. |
