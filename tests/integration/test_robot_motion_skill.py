...
class RobotMotionSkillIntegrationTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_move_out_of_dock(self) -> None:
        ...
        self.assertLessEqual(robot_message["payload"]["params"]["speed"], 0.2)
        self.assertLessEqual(robot_message["payload"]["params"]["distance_cm"], 2)
        self.assertLessEqual(robot_message["payload"]["timeout_ms"], 500)
    ...
    async def test_xiaoan_robot_care_tool_call_forwards_commands_and_records_tool_run(self) -> None:
        ...
        self.assertLessEqual(robot_messages[1]["payload"]["params"]["speed"], 0.2)
        self.assertLessEqual(robot_messages[1]["payload"]["params"]["distance_cm"], 2)
        self.assertLessEqual(robot_messages[1]["payload"]["timeout_ms"], 500)
